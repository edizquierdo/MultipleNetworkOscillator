...
#    ax1.set_ylabel('Body axis', fontsize = 22)
    plt.figtext(0.5, 0.955, 'Inactivated neurons in anterior three segments of the body Ind %d'%ind, fontsize = 24, va = 'center', ha = 'center')
    ...
    for position in [head, neck, tail]:
        ...
        p+=1
    np.savetxt('../../data/amplitude_fouad_ns_%d'%ind, amplitude_fouad)
