...
void Worm::Step(double StepSize, double muscle_input)
{
    int mi;
    ...
    mi = 1;
    dorsalInput  = muscle_input + NMJ_AS*n.NeuronOutput(nn(AS,mi)) + NMJ_DA*n.NeuronOutput(nn(DA,mi)) + NMJ_DB*n.NeuronOutput(nn(DB,mi)) + NMJ_DD*n.NeuronOutput(nn(DD,mi));
